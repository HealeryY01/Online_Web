<template>
  <div class="min-h-screen bg-gray-100 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 no-select">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
          <div class="p-6">
            <h3 class="text-lg font-medium text-gray-900 no-select">Kỳ thi sắp tới</h3>
            <div class="mt-4">
              <ul class="space-y-2">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
          <div class="p-6">
            <h3 class="text-lg font-medium text-gray-900 no-select">Kết quả gần đây</h3>
            <div class="mt-4">
              <ul class="space-y-2">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
          <div class="p-6">
            <h3 class="text-lg font-medium text-gray-900 no-select">Thống kê</h3>
            <div class="mt-4">
              <div class="flex justify-between mb-2 no-select">
